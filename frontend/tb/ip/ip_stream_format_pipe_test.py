...
def get_base_args():
    base_run_args = {}
    base_run_args["toplevel"] = "ip_stream_format_pipe_wrap"
    base_run_args["module"] = "common_tests"

    base_run_args["verilog_sources"] = [
                os.path.join(".", "ip_stream_format_pipe_wrap.sv"),
            ]
...
def test_basic_hdr_strip():
    ...
    base_run_args["sim_build"] = f"sim_build_pipe_basic"
    run(**base_run_args)

def test_val_rdy_bus():
    base_run_args = get_base_args()
    base_run_args["testcase"] = "val_rdy_test"
    base_run_args["sim_build"] = f"sim_build_pipe_valrdy"
    run(**base_run_args)
